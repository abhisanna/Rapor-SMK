      ...
      <div id="content" class="p-4 p-md-5 pt-5" id="invoice">
        <table width="100%;" border=1 style="color: black;"> 
            <thead>
                ...
                $result = mysqli_query($conn, "SELECT * FROM xiiakl_n ORDER BY id DESC");
                
                $row = mysqli_fetch_array($result);
                include 'xiiakl_walas/predikat.php';
                ...
                <tr>
                <th colspan="1" style="text-align: center;">1</th>
                <th colspan="4">Praktikum Akutansi Perusahaan Jasa, Dagang, dan Manufaktur</th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['prakjasdagp']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_prakjasdagp; echo $row ['p_prakjasdagp']?></th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['prakjasdagk']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_prakjasdagk; echo $row ['p_prakjasdagk']?></th>
                </tr>
                <tr>
                <th colspan="1" style="text-align: center;">2</th>
                <th colspan="4">Praktikum Akutansi Lembaga/Instansi Pemerintah</th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['prakakupemp']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_prakakupemp; echo $row ['p_prakakupemp']?></th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['prakakupemk']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_prakakupemk; echo $row ['p_prakakupemk']?></th>
                </tr>
                <tr>
                <th colspan="1" style="text-align: center;">3</th>
                <th colspan="4">Akutansi Keuangan</th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['akkeup']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_akkeup; echo $row ['p_akkeup']?></th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['akkeuk']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_akkeuk; echo $row ['p_akkeuk']?></th>
                </tr>
                <tr>
                <th colspan="1" style="text-align: center;">4</th>
                <th colspan="4">Komputer Akutansi</th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['kompakp']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_kompakp; echo $row ['p_kompakp']?></th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['kompakk']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_kompakk; echo $row ['p_kompakk']?></th>
                </tr>
                <tr>
                <th colspan="1" style="text-align: center;">5</th>
                <th colspan="4">Administrasi Pajak</th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['pajakp']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_pajakp; echo $row ['p_pajakp']?></th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['pajakk']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_pajakk; echo $row ['p_pajakk']?></th>
                </tr>
                <tr>
