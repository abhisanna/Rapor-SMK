...
if(!isset($_SESSION['uname'])) {
  header("location: index.php");
	...
	if($_SESSION['level'] !="produktifxotkp"){
  ...
  <body>
      ...
      <table class="table">
            ...
            <tbody>
                ...
                <td scope="col" style="text-align: center"><?php echo $data['koresponp']; ?></td>
                <td scope="col" style="text-align: center"><?php echo $data['koresponk']; ?></td>
                </tr>
                <?php } ?>
            </tbody>
            </table>
