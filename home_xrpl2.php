      ...
      <div id="content" class="p-4 p-md-5 pt-5" id="invoice">
        <table width="100%;" border=1 style="color: black;"> 
            <thead>
                ...
                $result = mysqli_query($conn, "SELECT * FROM xrpl2_n ORDER BY id DESC");
                
                $row = mysqli_fetch_array($result);
                include 'xrpl2_walas/predikat.php';
                ...
                <th colspan="1" style="text-align: center;">75</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['fisikap']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_fisikap; echo $row ['p_fisikap']?></th>
                <th colspan="1" style="text-align: center;">75</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['fisikak']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_fisikak; echo $row ['p_fisikak']?></th>
                </tr>
                <tr>
                <th colspan="1" style="text-align: center;">3</th>
                <th colspan="4">Kimia</th>
                <th colspan="1" style="text-align: center;">75</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['kimiap']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_kimiap; echo $row ['p_kimiap']?></th>
                <th colspan="1" style="text-align: center;">75</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['kimiak']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_kimiak; echo $row ['p_kimiak']?></th>
                </tr>
                <tr>
                ...
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['sistekomp']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_sistekomp; echo $row ['p_sistekomp']?></th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['sistekomk']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_sistekomk; echo $row ['p_sistekomk']?></th>
                </tr>
                <tr>
                <th colspan="1" style="text-align: center;">2</th>
                <th colspan="4">Komputer dan Jaringan Dasar</th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['komjardasp']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_komjardasp; echo $row ['p_komjardasp']?></th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['komjardask']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_komjardask; echo $row ['p_komjardask']?></th>
                </tr>
                <tr>
                <th colspan="1" style="text-align: center;">3</th>
                <th colspan="4">Pemrograman Dasar</th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['progdasp']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_progdasp; echo $row ['p_progdasp']?></th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['progdask']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_progdask; echo $row ['p_progdask']?></th>
                </tr>
                <tr>
                <th colspan="1" style="text-align: center;">4</th>
                <th colspan="4">Dasar Desain Grafis</th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['desgrafp']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_desgrafp; echo $row ['p_desgrafp']?></th>
                <th colspan="1" style="text-align: center;">78</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['desgrafk']; ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_desgrafk; echo $row ['p_desgrafk']?></th>
                </tr>
                <tbody>
            </tbody>
            </thead>
