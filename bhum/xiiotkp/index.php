...
if(!isset($_SESSION['uname'])) {
  header("location: index.php");
	...
	if($_SESSION['level'] !="budaya humanis"){
  ...
  <body>
      ...
      <table class="table">
            ...
            <tbody>
                ...
                <td scope="col" style="text-align: center"><?php echo $data['bhump']; ?></td>
                <td scope="col" style="text-align: center"><?php echo $data['bhumk']; ?></td>
                </tr>
                <?php } ?>
            </tbody>
            </table>
