...
if(!isset($_SESSION['uname'])) {
  ...
  if($_SESSION['level'] !="produktifxirpl"){
...
<html lang="en">
  ...
  <body>
        ...
        <li class="active">
                ...
                <li>
                    <a href="permod/index.php">Permodelan perangkat lunak</a>
                </li>
                <li>
                    <a href="basisdata/index.php">Basis data</a>
                </li>
                <li>
                    <a href="pbo/index.php">Permrograman berorientasi objek</a>
                </li>
                <li>
                    <a href="progweb/index.php">Pemrograman web dan perangkat bergerak</a>
                </li>
                <li>
