...
if(!isset($_SESSION['uname'])) {
  header("location: index.php");
	...
	if($_SESSION['level'] !="bahasa indonesia"){
  ...
  <body>
      ...
      <table class="table">
            ...
            <tbody>
                ...
                <td scope="col" style="text-align: center"><?php echo $data['bindop']; ?></td>
                <td scope="col" style="text-align: center"><?php echo $data['bindok']; ?></td>
                </tr>
                <?php } ?>
            </tbody>
            </table>
