      ...
      <div id="content" class="p-4 p-md-5 pt-5" id="invoice">
        <table width="100%;" border=1 style="color: black;"> 
            <thead>
                ...
                $result = mysqli_query($conn, "SELECT * FROM xotkp_n ORDER BY id DESC");
                
                $row = mysqli_fetch_array($result);
                include 'xotkp_walas/predikat.php';
                ...
                <tr>
                <th colspan="1" style="text-align: center;">1</th>
                <th colspan="4">Teknologi Perkantoran</th>
                <th colspan="1" style="text-align: center;">75</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['tekperp'] ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_tekperp; echo $row ['p_tekperp']?></th>
                <th colspan="1" style="text-align: center;">75</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['tekperk'] ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_tekperk; echo $row ['p_tekperk']?></th>
                </tr>
                <tr>
                <th colspan="1" style="text-align: center;">2</th>
                <th colspan="4">Korespondensi</th>
                <th colspan="1" style="text-align: center;">75</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['koresponp'] ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_koresponp; echo $row ['p_koresponp']?></th>
                <th colspan="1" style="text-align: center;">75</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['koresponk'] ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_koresponk; echo $row ['p_koresponk']?></th>
                </tr>
                <tr>
                <th colspan="1" style="text-align: center;">3</th>
                <th colspan="4">Kearsipan</th>
                <th colspan="1" style="text-align: center;">75</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['arsipp'] ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_arsipp; echo $row ['p_arsipp']?></th>
                <th colspan="1" style="text-align: center;">75</th>
                <th colspan="1" style="text-align: center;"><?php echo $row['arsipk'] ?></th>
                <th colspan="1" style="text-align: center;"><?php echo $p_arsipk; echo $row ['p_arsipk']?></th>
                </tr>
                <tbody>
            </tbody>
            </thead>
