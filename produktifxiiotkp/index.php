...
if(!isset($_SESSION['uname'])) {
  ...
  if($_SESSION['level'] !="produktifxiiotkp"){
...
<html lang="en">
  ...
  <body>
        ...
        <li class="active">
                ...
                <li>
                    <a href="kepegawaian/index.php">Otomatisasi tata kelola kepegawaian</a>
                </li>
                <li>
                    <a href="keuangan/index.php">Otomatisasi tata kelola keuangan</a>
                </li>
                <li>
                    <a href="sarpras/index.php">Otomatisasi tata kelola sarana dan prasarana</a>
                </li>
                <li>
                    <a href="keprotokolan/index.php">Otomatisasi tata kelola humas dan keprotokolan</a>
                </li>
                <li>
