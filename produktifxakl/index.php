...
if(!isset($_SESSION['uname'])) {
  ...
  if($_SESSION['level'] !="produktifxakl"){
...
<html lang="en">
  ...
  <body>
        ...
        <li class="active">
                ...
                <li>
                    <a href="etprof/index.php">Etika profesi</a>
                </li>
                <li>
                    <a href="spreadsheet/index.php">Spreadsheet</a>
                </li>
                <li>
                    <a href="akd/index.php">Akuntansi dasar</a>
                </li>
                <li>
                    <a href="perbankan/index.php">Perbankan dasar</a>
                </li>
	            </ul>
	        </li>
          <li class="active">
