...
<html lang="en">
  ...
  <body>
        ...
        <li class="active">
                ...
                <li>
                    <a href="sistekom/index.php">Sistem Komputer</a>
                </li>
                <li>
                    <a href="komjardas/index.php">Komputer dan jaringan dasar</a>
                </li>
                <li>
                    <a href="progdas/index.php">Pemrograman dasar</a>
                </li>
                <li>
                    <a href="desgraf/index.php">Dasar desain grafis</a>
                </li>
	            </ul>
	        </li>
          <li class="active">
