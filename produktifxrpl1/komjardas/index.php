...
if(!isset($_SESSION['uname'])) {
  header("location: index.php");
	...
	if($_SESSION['level'] !="produktifxrpl1"){
  ...
  <body>
      ...
      <table class="table">
            ...
            <tbody>
                ...
                <td scope="col" style="text-align: center"><?php echo $data['komjardasp']; ?></td>
                <td scope="col" style="text-align: center"><?php echo $data['komjardask']; ?></td>
                </tr>
                <?php } ?>
            </tbody>
            </table>
