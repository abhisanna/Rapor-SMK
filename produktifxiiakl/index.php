...
if(!isset($_SESSION['uname'])) {
  ...
  if($_SESSION['level'] !="produktifxiiakl"){
...
<html lang="en">
  ...
  <body>
        ...
        <li class="active">
                ...
                <li>
                    <a href="jasdag/index.php">Praktikum akuntansi perusahaan jasa, dagang, dan manufaktur</a>
                </li>
                <li>
                    <a href="akupem/index.php">Praktikum akuntansi lembaga/instansi pemerintah</a>
                </li>
                <li>
                    <a href="akkeu/index.php">Akuntansi keuangan</a>
                </li>
                <li>
                    <a href="kompak/index.php">Komputer akuntansi</a>
                </li>
                <li>
                    <a href="pajak/index.php">Administrasi pajak</a>
                </li>
                <li>
                    <a href="kwu/index.php">Produk kreatif dan kewirausahaan</a>
                </li>
	            </ul>
	        </li>
          <li class="active">
