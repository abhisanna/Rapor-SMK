...
$result = mysqli_query($conn, "SELECT * FROM xotkp_n");
?>
...
<td colspan=4 align=center>Teknologi Perkantoran</td>
<td colspan=4 align=center>Korespondensi</td>
<td colspan=4 align=center>Kearsipan</td>
...
<!-- tekper -->
<td><?php echo $row ["tekperp"]?></td>
<td><?php echo $p_tekperp; echo $row ["p_tekperp"]?></td>
<td><?php echo $row ["tekperk"]?></td>
<td><?php echo $p_tekperk; echo $row ["p_tekperk"]?></td>

<!-- korespon -->
<td><?php echo $row ["koresponp"]?></td>
<td><?php echo $p_koresponp; echo $row ["p_koresponp"]?></td>
<td><?php echo $row ["koresponk"]?></td>
<td><?php echo $p_koresponk; echo $row ["p_koresponk"]?></td>

<!-- arsip -->
<td><?php echo $row ["arsipp"]?></td>
<td><?php echo $p_arsipp; echo $row ["p_arsipp"]?></td>
<td><?php echo $row ["arsipk"]?></td>
<td><?php echo $p_arsipk; echo $row ["p_arsipk"]?></td>
