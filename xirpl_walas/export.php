...
$result = mysqli_query($conn, "SELECT * FROM xirpl_n");
?>
...
<td colspan=6 align=center rowspan=3>Kegiatan Ekstrakulikuler</td>
...
<td colspan=4 align=center>Permodelan Perangkat Lunak</td>
<td colspan=4 align=center>Basis Data</td>
<td colspan=4 align=center>Pemrograman Berorientasi Objek</td>
<td colspan=4 align=center>Pemrograman Web dan Perangkat Bergerak</td>
...
<td><?php echo $p_permodp; echo $row ["p_permodp"]?></td>
<td><?php echo $row ["permodk"]?></td>
<td><?php echo $p_permodk; echo $row ["p_permodk"]?></td>

<!-- basis data -->
<td><?php echo $row ["basdatap"]?></td>
<td><?php echo $p_basdatap; echo $row ["p_basdatap"]?></td>
<td><?php echo $row ["basdatak"]?></td>
<td><?php echo $p_basdatak; echo $row ["p_basdatak"]?></td>

<!-- pbo -->
<td><?php echo $row ["pbop"]?></td>
<td><?php echo $p_pbop; echo $row ["p_pbop"]?></td>
<td><?php echo $row ["pbok"]?></td>
<td><?php echo $p_pbok; echo $row ["p_pbok"]?></td>

<!-- progweb -->
<td><?php echo $row ["progwebp"]?></td>
<td><?php echo $p_progwebp; echo $row ["p_progwebp"]?></td>
<td><?php echo $row ["progwebk"]?></td>
<td><?php echo $p_progwebk; echo $row ["p_progwebk"]?></td>
